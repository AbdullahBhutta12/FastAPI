...
#     Todo(todo_id= 3, todo_name= 'Shop', todo_description= 'Go for shopping', priority=Priority.LOW),
#     Todo(todo_id= 4, todo_name= 'Study', todo_description= 'Study for exams', priority=Priority.MEDIUM),
#     Todo(todo_id= 5, todo_name= 'Meditate', todo_description= 'Meditate for 20 munits', priority=Priority.LOW)
# ]
#
# @api.get('/about')
# def about():
